...
简单使用 http://www.cnblogs.com/tonycheng93/p/6295724.html
...
上拉加载
    ...
    recyclerviewadapterhelper
        ...
        (注意：baseViewHoldew.getAdaoter.getPosition()所得到的下标是从1开始的，需要-1)
...
RecyclerView 条目居中或者居左效果
LinearSnapHelper().attachToRecyclerView(recyclerView);
        http://blog.csdn.net/li15225271052/article/details/54747359
...
VirtualLayout是一个针对RecyclerView的LayoutManager扩展, 主要提供一整套布局方案和布局间的组件复用的问题。可以实现复杂的规则表格页面 类似微医的首页

类似微信朋友圈的下拉图片放大的效果 scrollview
        https://github.com/ksoichiro/Android-ObservableScrollView

Google andorid 中国开发者网站
...
抓包工具Fidlling4 
抓取手机app数据需要的配置
        http://jingyan.baidu.com/article/3a2f7c2e0d5f2126aed61175.html
